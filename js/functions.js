...
! function(e) {
    ...
    SEMICOLON.initialize = {
        ...
        init: function() {
            SEMICOLON.header.superfish(), SEMICOLON.header.menufunctions(), SEMICOLON.header.fullWidthMenu(), SEMICOLON.header.overlayMenu(), SEMICOLON.header.stickyMenu(), SEMICOLON.header.stickyPageMenu(), SEMICOLON.header.sideHeader(), SEMICOLON.header.sidePanel(), SEMICOLON.header.forcetenScroll(), SEMICOLON.header.forcetenScroller(), SEMICOLON.header.logo(), SEMICOLON.header.topsearch(), SEMICOLON.header.topcart()
        },
        superfish: function() {
        ...
        forcetenScroller: function() {
            x.find("li").removeClass("current"), x.find('a[data-href="#' + SEMICOLON.header.forcetenCurrentSection() + '"]').parent("li").addClass("current")
        },
        forcetenCurrentSection: function() {
            var i = "home",
                s = n.outerHeight();
        ...
        windowscroll: function() {
            ...
            SEMICOLON.header.stickyMenu(i), SEMICOLON.header.stickyPageMenu(o), t.on("scroll", function() {
                ...
                SEMICOLON.header.forcetenScroller()
